...
<html>
	...
	<body>
		<div class = "header">
			...
			<div class = "read">
			<button class = "btn"><a href="testadd.php">Add items</a>  
			</button><br><br>
  ...
  <?php
	...
	//$i = 1;
	$rows = mysqli_query($conn, "SELECT * FROM items ORDER BY Item_id DESC");
	?>
	...
	<td>
	<button><a href="update.php?updateid=<?php echo $id; ?>" class="btn">Update</a></button>
	<button><a href="delete.php?deleteid=<?php echo $id; ?>" class="btn">Delete</a></button>
	</td>
	</tr>
	<?php endforeach; ?>
